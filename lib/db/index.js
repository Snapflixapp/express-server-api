...
User.register = (username, password) => {
  const passwordData = User.generateHash(password)
      ...
      .then((user) => {
        return times(random(1, 3), () => {
          ...
          return user.createVideo({
            ...
            key: video.key,
            url: 'https://s3-us-west-1.amazonaws.com/snapflix-videos-raw/341ee1bb-7bcd-4f7c-8d89-0e5064dd4ada/eafa7564-9c88-48b5-b7f2-2f8a9a3c5bf1' // `https://s3-us-west-1.amazonaws.com/snapflix-videos-raw/${video.key}`
          })
        })
      })
      .then(() => {
